...
void __fastcall TFormColors::ShowColorHead(){
 ...
 X=(ImageHead->ClientWidth-ImageHead->Canvas->TextWidth(L"ÇÀÃÎËÎÂÎÊ"))/2;
 Y=(ImageHead->ClientHeight-ImageHead->Canvas->TextHeight(L"Ç"))/2;
 ImageHead->Canvas->TextOut(X,Y,L"ÇÀÃÎËÎÂÎÊ");
}
//---------------------------------------------------------------------------
void __fastcall TFormColors::ShowColorOs(){
 ...
 X=(ImageOs->ClientWidth-ImageOs->Canvas->TextWidth(L"Íàçâàíèÿ îñåé"))/2;
 Y=(ImageOs->ClientHeight-ImageOs->Canvas->TextHeight(L"Í"))/2;
 ImageOs->Canvas->TextOut(X,Y,L"Íàçâàíèÿ îñåé");
}
//---------------------------------------------------------------------------
...
void __fastcall TFormColors::ShowColorDigit(){
 ...
 X=(ImageDigit->ClientWidth-ImageDigit->Canvas->TextWidth(L"1234567890"))/2;
 Y=(ImageDigit->ClientHeight-ImageDigit->Canvas->TextHeight(L"1"))/2;
 ImageDigit->Canvas->TextOut(X,Y,L"1234567890");
}
//---------------------------------------------------------------------------
