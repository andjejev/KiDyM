...
class TMultFilms{
 public:
   ...
   *ToolButtonRead;
  void *CalcQ;
  AnsiString Head; char NameY[256],NameX[256];
  TMultFilms(TMenuItem *MMF,TMenuItem *mMF0,TMenuItem *mMF1,
   ...
   int *WP,long *Tm,int *Kk,TImage *Im,TImage *PIm,/*TProcProc *PP,*/TCGauge *CG,
  ...
  void __fastcall HingeFixedTest(Root *Tv,Parm *p,Magazine *m);
  ...
  Parm *__fastcall GabaritFixHinge(Parm *P);
  Parm *__fastcall GabaritMultiLink(Parm *P);
  Parm *__fastcall GabaritCentroids(Parm *P,int i);
  Parm *__fastcall GabaritSpline(Parm *P);
  Parm *__fastcall GabaritTraector(Parm *P);
  ...
  Parm *__fastcall DrawFixHinge(TCanvas *Canvas,Parm *P);
  Parm *__fastcall DrawMultiLink(TCanvas *Canvas,Parm *P);
  Parm *__fastcall DrawFixedCentroids(TCanvas *Canvas,Parm *P);
  Parm *__fastcall DrawMobileCentroids(TCanvas *Canvas,Parm *P,int i);
  Parm *__fastcall DrawSpline(TCanvas *Canvas,Parm *P);
  Parm *__fastcall DrawTraector(TCanvas *Canvas,Parm *P);
  ...
  Parm *__fastcall ParmText(Parm *P,int &X,int &Y,int &Size,TColor &Color,char **T);
...
//  Parm *__fastcall ParmCentroids(Parm *P,double &xA,double &yA,double &Fi,
//   int &Width,TColor &Ck,TColor &Cf);

  void  __fastcall ToBMP(TTabControl *TabControl,bool Message);
  void  __fastcall Include(TTabControl *TabControl);
  Parm *__fastcall ParmFixHinge(Parm *P,int &XO,int &YO,
